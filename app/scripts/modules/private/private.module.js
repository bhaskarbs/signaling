 ...
 */
angular
    .module('saintApp', ['ui.date', 'ngLocalize', 'angularUtils.directives.dirPagination', 'saint-config', 'ui.router', 'ui.bootstrap', 'icomps', 'ngynSelect2', 'gantt', 'ngTouch', 'ui.select', 'saint-authorize', 'as.sortable', 'angularTreeview', 'common.providers', 'ui.tree', 'slick'])
